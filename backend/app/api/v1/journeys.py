...
def start_journey(citizen_id: str, request: StartJourneyRequest) -> JourneyDetailView:
    try:
...
def list_journeys(citizen_id: str) -> list[JourneySummaryView]:
...
def _require_journey(application_id: str) -> Journey:
...
def get_journey_detail(application_id: str) -> JourneyDetailView:
    return _to_detail(_require_journey(application_id))


@router.post("/journeys/{application_id}/consent/{service_code}", response_model=JourneyDetailView)
def grant_consent(application_id: str, service_code: str, request: GrantConsentRequest) -> JourneyDetailView:
    _require_journey(application_id)
    try:
...
def revoke_consent(application_id: str, service_code: str) -> JourneyDetailView:
    _require_journey(application_id)
...
def submit_service(application_id: str, service_code: str, request: SubmitRequest) -> JourneyDetailView:
    journey = _require_journey(application_id)
    try:
...
def approve_service(application_id: str, service_code: str) -> JourneyDetailView:
